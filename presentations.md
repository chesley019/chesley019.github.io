...
<div class="pub-carousel-container">
    ...
    <button class="pub-carousel-btn pub-prev-btn" onclick="movePubSlide('pub-track-1', -1)">&#10094;</button>
    <button class="pub-carousel-btn pub-next-btn" onclick="movePubSlide('pub-track-1', 1)">&#10095;</button>
</div>
...
<script>
    function movePubSlide(trackId, direction) {
